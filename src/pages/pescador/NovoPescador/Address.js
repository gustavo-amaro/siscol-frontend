    ...
    <div className="container-fluid">
        ...
        {fisherAddresses.map(address=>{
                return(
                    ...
                    <form className="col s12" onSubmit={e=>updateAddress(e, address.id)}  style={{marginTop: 40}}>
                <div className="row">
                    <div className="input-field col m4">
                        <input id={"logradouro"+address.id} name="logradouro" type="text" defaultValue={address.logradouro}/>
                        <label htmlFor={"logradouro"+address.id}>Logradouro</label>
                    </div>
                    <div className="input-field col m4">
                        <input id={"numero"+address.id} type="text" name="numero" defaultValue={address.numero}/>
                        <label htmlFor={"numero"+address.id}>Numero</label>
                    </div>
                    <div className="input-field col m4 s12">
                        <input id={"bairro"+address.id} type="text" name="bairro" defaultValue={address.bairro}/>
                        <label htmlFor={"bairro"+address.id}>Bairro</label> 
                    </div>
                    <div className="input-field col m4">
                        <input id={"cidade"+address.id} name="cidade" type="text" defaultValue={address.cidade}/>
                        <label htmlFor={"cidade"+address.id}>Cidade</label>
                    </div>
                    <div className="input-field col m4">
                        <input id={"estado"+address.id} type="text" name="estado" defaultValue={address.estado}/>
                        <label htmlFor={"estado"+address.id}>Estado</label>
                    </div>
                    <div className="input-field col m4 s12">
                        <input id={"cep"+address.id} type="text" name="cep" defaultValue={address.cep}/>
                ...
                <div className="row">
                    ...
                    <div className="col m4 s12">
                        <button type="submit" className="btn primary waves-effect" style={{width: '100%'}}>Atualizar Endereço</button>
                        <button 
                        type="button" 
        ...
        <div className="row card" style={{display:showNewAddress?'block':'none'}}>
